...
public class NEmailVal4 extends BaseTest {
	...
	public void initJsonReader() throws FileNotFoundException, IOException, ParseException {
		...
		dataReader.JsonReader("n_email_val_4");
	}

	@Test
	@Description("Test all fields are valid but the email field missing first part {before @}. 1. Open the sign up page...")
	...
	@Description("Test all fields are valid but the email field missing first part {before @}. 2. Enter sign up data...")
	...
	@Description("Test all fields are valid but the email field missing first part {before @}. 3. Verify unsuccessful registeration...")
