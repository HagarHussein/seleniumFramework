...
public class NPwdNnchar extends BaseTest {
	...
	public void initJsonReader() throws FileNotFoundException, IOException, ParseException {
		...
		dataReader.JsonReader("n_pwd_nChar");
	}
	
	@Test
	@Description("Test all fields are valid but the password does not contain any char. 1. Open the sign up page...")
	...
	@Description("Test all fields are valid but the password does not contain any char. 2. Enter sign up data...")
	...
	@Description("Test all fields are valid but the password does not contain any char. 3. Verify unsuccessful registeration...")
