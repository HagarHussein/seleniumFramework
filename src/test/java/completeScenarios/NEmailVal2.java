...
public class NEmailVal2 extends BaseTest {
	...
	public void initJsonReader() throws FileNotFoundException, IOException, ParseException {
		...
		dataReader.JsonReader("n_email_val_2");
	}
	
	@Test
	@Description("Test all fields are valid but the email field missing the {.com}. 1. Open the sign up page...")
	...
	@Description("Test all fields are valid but the email field missing the {.com}. 2. Enter sign up data...")
	...
	@Description("Test all fields are valid but the email field missing the {.com}. 3. Verify unsuccessful registeration...")
