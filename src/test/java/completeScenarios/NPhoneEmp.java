...
public class NPhoneEmp extends BaseTest {
	...
	public void initJsonReader() throws FileNotFoundException, IOException, ParseException {
		...
		dataReader.JsonReader("n_phone_emp");
	}
	
	@Test
	@Description("Test all fields are valid except for phone field empty. 1. Open the sign up page...")
	...
	@Description("Test all fields are valid except for phone field empty. 2. Enter sign up data...")
	...
	@Description("Test all fields are valid except for phone field empty. 3. Verify unsuccessful registeration...")
