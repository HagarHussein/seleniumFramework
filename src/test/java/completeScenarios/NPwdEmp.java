...
public class NPwdEmp extends BaseTest {
	...
	public void initJsonReader() throws FileNotFoundException, IOException, ParseException {
		...
		dataReader.JsonReader("n_pwd_emp");
	}
	
	@Test
	@Description("Test all fields are valid except for password field empty. /n 1. Open the sign up page...")
	...
	@Description("Test all fields are valid except for password field empty. /n 2. Enter sign up data...")
	...
	@Description("Test all fields are valid except for password field empty. \n 3. Verify unsuccessful registeration...")
