...
public class NPwdNlc extends BaseTest {
	...
	public void initJsonReader() throws FileNotFoundException, IOException, ParseException {
		...
		dataReader.JsonReader("n_pwd_nLC");
	}
	
	@Test
	@Description("Test all fields are valid but the password does not contain lower case char. 1. Open the sign up page...")
	...
	@Description("Test all fields are valid but the password does not contain lower case char. 2. Enter sign up data...")
	...
	@Description("Test all fields are valid but the password does not contain lower case char. 3. Verify unsuccessful registeration...")
