...
public class NFnameLnameWrong extends BaseTest {
	...
	public void initJsonReader() throws FileNotFoundException, IOException, ParseException {
		...
		dataReader.JsonReader("n_fname_lname_wrong");
	}
	
	@Test
	@Description("Test all fields are valid but the first & last name does not start with a capital letter. 1. Open the sign up page...")
	...
	@Description("Test all fields are valid but the first & last name do not start with a capital letter. 2. Enter sign up data...")
	...
	@Description("Test all fields are valid but the first & last name do not start with a capital letter. 3. Verify unsuccessful registeration...")
	public void verifyUnSuccessfulRegisteration() {
		/* Assumption: there should be an error message "Please choose First & Last Name that starts with a capital letter"
