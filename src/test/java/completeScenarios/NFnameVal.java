...
public class NFnameVal extends BaseTest {
	...
	public void initJsonReader() throws FileNotFoundException, IOException, ParseException {
		...
		dataReader.JsonReader("n_fname_val");
	}
	
	@Test
	@Description("Test all fields are valid but the first name does not start with a capital letter. 1. Open the sign up page...")
	...
	@Description("Test all fields are valid but the first name does not start with a capital letter. 2. Enter sign up data...")
	...
	@Description("Test all fields are valid but the first name does not start with a capital letter. 3. Verify unsuccessful registeration...")
	public void verifyUnSuccessfulRegisteration() {
		/* Assumption: there should be an error message "Please choose First Name that starts with a capital letter"
