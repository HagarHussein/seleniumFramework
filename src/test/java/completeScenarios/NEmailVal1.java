...
public class NEmailVal1 extends BaseTest {
	...
	public void initJsonReader() throws FileNotFoundException, IOException, ParseException {
		...
		dataReader.JsonReader("n_email_val_1");
	}
	
	@Test
	@Description("Test all fields are valid but the email field is not gmail {outlook}. 1. Open the sign up page...")
	...
	@Description("Test all fields are valid but the email field is not gmail {outlook}. 2. Enter sign up data...")
	...
	@Description("Test all fields are valid but the email field is not gmail {outlook}. 3. Verify unsuccessful registeration...")
