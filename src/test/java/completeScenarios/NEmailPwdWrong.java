...
public class NEmailPwdWrong extends BaseTest {
	...
	public void initJsonReader() throws FileNotFoundException, IOException, ParseException {
		...
		dataReader.JsonReader("n_pwd_email_wrong");
	}
	
	@Test
	@Description("Test all fields are valid but the email and password fields does not match the validation requirements. 1. Open the sign up page...")
	...
	@Description("Test all fields are valid but the email and password fields does not match the validation requirements. 2. Enter sign up data...")
	...
	@Description("Test all fields are valid but the email and password fields does not match the validation requirements. 3. Verify unsuccessful registeration...")
