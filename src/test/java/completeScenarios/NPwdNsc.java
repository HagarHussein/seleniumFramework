...
public class NPwdNsc extends BaseTest {
	...
	public void initJsonReader() throws FileNotFoundException, IOException, ParseException {
		...
		dataReader.JsonReader("n_pwd_nSC");
	}
	
	@Test
	@Description("Test all fields are valid but the password does not contain a special chars. 1. Open the sign up page...")
	...
	@Description("Test all fields are valid but the password does not contain a special char. 2. Enter sign up data...")
	...
	@Description("Test all fields are valid but the password does not contain a special char. 3. Verify unsuccessful registeration...")
