...
public class NPwdNMatch extends BaseTest {
	...
	public void initJsonReader() throws FileNotFoundException, IOException, ParseException {
		...
		dataReader.JsonReader("n_pwd_nmatch");
	}
	
	@Test
	@Description("Test all fields are valid except for password fields does not match. /n 1. Open the sign up page...")
	...
	@Description("Test all fields are valid except for password fields does not match. /n 2. Enter sign up data...")
	...
	@Description("Test all fields are valid except for password fields does not match. \n 3. Verify unsuccessful registeration...")
	public void verifyUnSuccessfulRegisteration() {
		// Expect the error message will appear
		assertEquals(accountPage.getAlertMsgText(), "Password not matching with confirm password.");
